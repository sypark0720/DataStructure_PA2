...
implements Dictionary<Key, E> {
	...
	private BSTNode<Key,E> inorderHelper(BSTNode<Key, E> rt, SingleLinkedList<Key> list){
		if (rt==null) return null;
		list.append(inorderHelper(rt.right(), list).key());
		list.append(rt.key());
		list.append(inorderHelper(rt.left(), list).key());
		return rt;		
	}
